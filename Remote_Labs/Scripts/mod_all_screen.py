...
os.system("python3 bb3_screen.py")
os.system("python3 os_screen.py")
os.system("python3 ps_screen.py")
os.system("python3 sa_screen.py")
os.system("python3 sg_screen.py")
